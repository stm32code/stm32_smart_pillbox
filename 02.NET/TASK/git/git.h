...
#endif
// 设备信息
#define PROID "smartdevice&k11q5zNEelo"															 // 产品ID
#define DEVID "k11q5zNEelo.smartdevice|securemode=2,signmethod=hmacsha256,timestamp=1741864657515|" // 设备ID
#define AUTH_INFO "755f7e09aee2211d192edeed9d02acd8feb8f5257ee5553f7c77d5209096f541"						 // 鉴权信息
// MQTT主题 /broadcast/
#define S_TOPIC_NAME "/broadcast/k11q5zNEelo/test1" // 需要订阅的主题
#define P_TOPIC_NAME "/broadcast/k11q5zNEelo/test2" // 需要发布的主题
